...
5: pray that it worked (if it keeps silent, it probably worked).


for hotkeys n stuff (one anon aksed for it), take a look at the config.txt
there were some bugfixes. config now also supports ASCII-hotkeys.